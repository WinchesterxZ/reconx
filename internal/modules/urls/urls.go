...
// waymore explicitly asks for root domains, not subdomains.
func extractRootDomains(hosts []string) []string {
	...
	for _, h := range hosts {
		...
		// Get root: last two parts of domain
